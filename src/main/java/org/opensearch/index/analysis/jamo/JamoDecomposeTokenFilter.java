...
public final class JamoDecomposeTokenFilter extends TokenFilter {

    private final KoreanJamoParser parser;
    private final CharTermAttribute termAtt;

    public JamoDecomposeTokenFilter(TokenStream stream) {
        super(stream);
    ...
    public boolean incrementToken() throws IOException {
        ...
        if (input.incrementToken()) {
            final CharSequence parserdData = parser.parse(termAtt.toString());
            termAtt.setEmpty();
